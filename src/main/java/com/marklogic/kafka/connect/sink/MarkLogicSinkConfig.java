...
public class MarkLogicSinkConfig extends AbstractConfig {
	...
	public static final String DOCUMENT_COLLECTIONS_ADD_TOPIC = "ml.document.collections.add.topic";
	...
	public static ConfigDef CONFIG_DEF = new ConfigDef()
		...
		.define(DOCUMENT_COLLECTIONS_ADD_TOPIC, Type.BOOLEAN, true,Importance.LOW, "Boolean that indicate if tpoics should be add to documents collections ")
