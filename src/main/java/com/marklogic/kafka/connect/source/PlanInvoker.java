...
/**
 * Strategy interface for how a plan is invoked; "invoke" is the chosen term per
 * the docs at
...
public interface PlanInvoker {
    ...
    /**
     * Invoke the given plan, returning a Results object containing source records
    ...
    /**
     * Primary purpose of the class is to transfer the source records along with the
     * MarkLogic server timestamp at
     * which the Plan was invoked, thus allowing for the max value of a particular
     * column to be calculated using that
     * same timestamp.
     */
    class Results {
